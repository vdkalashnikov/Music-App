  ...
  <div class="card">
        ...
        <?php endif; ?>
          ...
          <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
            ...
            <input type="password" class="input-field" placeholder="New Password..." name="new_password" autocomplete="off" value="<?= set_value('new_password'); ?>">
          </div>
        ...
        <?php endif; ?>
          ...
          <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
            ...
            <input type="password" class="input-field" placeholder="Confirm New Password..." name="confirm_new_password" value="<?= set_value('confirm_new_password'); ?>">
          </div>
