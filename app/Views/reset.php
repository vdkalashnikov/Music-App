  ...
  <div class="login_form_container">
    ...
    <form action="<?= route_to('reset-password-handler', $token); ?>" method="POST">
        ...
        <div class="input_group">
          ...
          <input type="text" placeholder="New Password" class="input_text" autocomplete="off" name="new_password" value="<?= set_value('new_password'); ?>">
        </div>
        ...
        <div class="input_group">
          <i class="fa fa-user"></i>
          <input type="text" placeholder="Confirm New Password" class="input_text" autocomplete="off" name="confirm_new_password" value="<?= set_value('confirm_new_password'); ?>">
        </div>
